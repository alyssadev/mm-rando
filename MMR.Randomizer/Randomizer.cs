...
namespace MMR.Randomizer
{
    ...
    {
        public static readonly string AssemblyVersion = Assembly.GetExecutingAssembly()?.GetCustomAttribute<AssemblyInformationalVersionAttribute>()?.InformationalVersion;
